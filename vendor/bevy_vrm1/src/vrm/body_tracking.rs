...
///
/// Insert alongside [`LookAt`] for the legacy gaze-target path, or alongside
/// [`BodyTrackingPoseInput`] for calibrated direct yaw, pitch, and roll input.
///
/// ```no_run
/// use bevy::prelude::*;
...
pub(super) fn compute_additive_rotation(
    base: Quat,
    rest: Quat,
    gaze: Quat,
) -> Quat {
